...
class BccClient(bce_base_client.BceBaseClient):
    ...
    @required(cpu_count=int, memory_capacity_in_gb=int, dedicated_host_id=(str, str),
              image_id=(str, str))
    ...
    @required(security_group_id=(str, str))
